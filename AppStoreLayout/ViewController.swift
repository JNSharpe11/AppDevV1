...
class ViewController: UIViewController {
    ...
    // NEED TO FIND A PLACE FOR THIS: section.orthographyScrollingBehavior = groupPagingCentered
    ...
    func configureDataSource() {
        ...
        dataSource = .init(collectionView: collectionView, cellProvider: {
            ...
            case .standard:
                let cell = collectionView.dequeueReusableCell(withReuseIdentifier: StandardAppCollectionViewCell.reuseIdentifier, for: indexPath) as!
                StandardAppCollectionViewCell
            ...
            case .categories:
                let cell = collectionView.dequeueReusableCell(withReuseIdentifier: CategoryCollectionViewCell.reuseIdentifier, for: indexPath) as!
        ...
        //let promotedSection = Section.promoted("Futures")
        ...
        //snapshot.appendItems(Item.promotedApps, toSection: promotedSection)
